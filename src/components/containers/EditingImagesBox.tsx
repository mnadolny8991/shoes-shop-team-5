...
export default function EditingImagesBox({initialImages=[]}: {initialImages?: ProductImage[]}){
    ...
    return(
        ...
        {images.map((image) => (
          ...
          >
            ...
            >
              <IconButton
                  sx={{width:'80px', height:'80px', backgroundColor:'#ffffff59', '&:hover':{backgroundColor:'#ffffffb3'}}}
