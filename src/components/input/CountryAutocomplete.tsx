...
export default function CountryAutocomplete({error, value, onChange, onBlur}:CountryAutocompleteProps){
    const [inputValue, setInputValue] = useState('');
    return(
        <InputFieldContainer id="country" label="Country" required  error={error} width='100%'>
        <Autocomplete
          onBlur={onBlur}
            value={value}
