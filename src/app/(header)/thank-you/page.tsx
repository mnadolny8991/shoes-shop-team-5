...
export default function ThankYou(){
    ...
    useEffect(()=>{
        if((payment?.paymentIntentId === searchParams.get("payment_intent")) &&  searchParams.get("redirect_status")==="succeeded"){
    ...
    return(
        ...
        >
            <Box maxWidth={820} mb={9}>
                <Typography fontSize={{xs:50, sm:90, md:140}} fontWeight={900} lineHeight='1.2em'>THANK YOU</Typography>
                <Typography variant="h1" fontStyle={'italic'}>
                    for your order <Typography component={'span'} color={'primary.main'} fontStyle='normal'>#{orderId}</Typography>    
                </Typography>
                ...
                <Stack direction="row" spacing={4} width={{xs:340, sm:592}} maxWidth='95vw'>
            ...
            <Box width={{ xs: '100vw', sm: 493.8 }} position="relative" top={{lg:90}}>
                <Image
